...
const (
	...
	EventService_EventAttendace_FullMethodName = "/event.EventService/EventAttendace"
)
...
type EventServiceClient interface {
	...
	EventAttendace(ctx context.Context, in *EventAttendaceRequest, opts ...grpc.CallOption) (*EventAttendaceResponse, error)
}
...
func (c *eventServiceClient) EventAttendace(ctx context.Context, in *EventAttendaceRequest, opts ...grpc.CallOption) (*EventAttendaceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EventAttendaceResponse)
	err := c.cc.Invoke(ctx, EventService_EventAttendace_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EventServiceServer interface {
	...
	EventAttendace(context.Context, *EventAttendaceRequest) (*EventAttendaceResponse, error)
...
func (UnimplementedEventServiceServer) EventAttendace(context.Context, *EventAttendaceRequest) (*EventAttendaceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EventAttendace not implemented")
}
...
func _EventService_EventAttendace_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EventAttendaceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EventServiceServer).EventAttendace(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EventService_EventAttendace_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventServiceServer).EventAttendace(ctx, req.(*EventAttendaceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EventService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "EventAttendace",
			Handler:    _EventService_EventAttendace_Handler,
		},
	},
