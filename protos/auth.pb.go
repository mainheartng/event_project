...
const file_protos_auth_proto_rawDesc = "" +
	"\n" +
	"\x11protos/auth.proto\x12\x04auth\x1a\x12protos/types.proto\"\xa8\x01\n" +
	...
	"\tlast_name\x18\x05 \x01(\tR\blastNameB\b\n" +
	"\x06_phone\"k\n" +
	...
	"\n" +
	"LogoutUser\x12\x17.auth.LogoutUserRequest\x1a\x18.auth.LogoutUserResponseB4Z2github.com/mainheartng/event_project/protos;protosb\x06proto3"
