...
const file_protos_user_proto_rawDesc = "" +
	...
	"\asuccess\x18\x01 \x01(\tR\asuccess\"\xc6\x01\n" +
	...
	"\n" +
	"RevokeRole\x12\x17.user.RevokeRoleRequest\x1a\x18.user.RevokeRoleResponseB4Z2github.com/mainheartng/event_project/protos;protosb\x06proto3"
...
var file_protos_user_proto_depIdxs = []int32{
	...
	18, // 4: user.ListUsersRequest.pagination:type_name -> types.PageRequest
	19, // 5: user.ListUsersRequest.status_filter:type_name -> types.Status
	17, // 6: user.ListUsersResponse.users:type_name -> types.User
	20, // 7: user.ListUsersResponse.pagination:type_name -> types.PageResponse
	0,  // 8: user.UserService.GetUserByID:input_type -> user.GetUserByIDRequest
	2,  // 9: user.UserService.GetUserByEmail:input_type -> user.GetUserByEmailRequest
	4,  // 10: user.UserService.UpdateUser:input_type -> user.UpdateUserRequest
	5,  // 11: user.UserService.UpdateUserPassword:input_type -> user.UpdateUserPasswordRequest
	9,  // 12: user.UserService.DeleteUser:input_type -> user.DeleteUserRequest
	11, // 13: user.UserService.ListUsers:input_type -> user.ListUsersRequest
	13, // 14: user.UserService.AssignRole:input_type -> user.AssignRoleRequest
	15, // 15: user.UserService.RevokeRole:input_type -> user.RevokeRoleRequest
	1,  // 16: user.UserService.GetUserByID:output_type -> user.GetUserByIDResponse
	3,  // 17: user.UserService.GetUserByEmail:output_type -> user.GetUserByEmailResponse
	8,  // 18: user.UserService.UpdateUser:output_type -> user.UpdateUserResponse
	6,  // 19: user.UserService.UpdateUserPassword:output_type -> user.UpdateUserPasswordResponse
	10, // 20: user.UserService.DeleteUser:output_type -> user.DeleteUserResponse
	12, // 21: user.UserService.ListUsers:output_type -> user.ListUsersResponse
	14, // 22: user.UserService.AssignRole:output_type -> user.AssignRoleResponse
	16, // 23: user.UserService.RevokeRole:output_type -> user.RevokeRoleResponse
